...
const imageProductEl = document.getElementById("img")
const descriptionProductEl = document.getElementById("description")
const priceProductEl = document.getElementById("price")
const rateProductEl = document.getElementById("rating")
const reviewProductEl = document.getElementById("review")
const stockProductEl = document.getElementById("stock")


titleTextEl.textContent = product.title

imageProductEl.src = product.images[0]

descriptionProductEl.textContent = product.description

priceProductEl.textContent = product.price

rateProductEl.textContent = product.rating

stockProductEl.textContent = product.stock

// product.reviews.forEach(item => {
//     // console.log(item)

//     const newDiv = document.createElement("div")
//     reviewProductEl.appendChild(newDiv)
//     const productName = document.createElement('h2');
//     productName.textContent = product.name;


//         newDiv.innerHTML = `
//             <p class="review">${item.reviewerName}</p>
//             <p class="review">${item.reviewerEmail}</p>
//             <p class="review">${item.date}</p>
...
function renderProducts(products) {
    ...
    products.forEach(product => {
        ...
        productDescriptionDiv.appendChild(productDescriptionEl)

        const productPriceDiv = document.createElement('div')
        productPriceDiv.classList.add('infor', 'product-price')
        const productPriceInforEl = document.createElement('p')
        productPriceInforEl.classList.add('inforName')
        productPriceInforEl.textContent = 'Price:'
        productPriceDiv.appendChild(productPriceInforEl)
        const productPriceValueEl = document.createElement('p')
        productPriceValueEl.classList.add('inforValue')
        productPriceValueEl.textContent = product.price
        productPriceDiv.appendChild(productPriceValueEl)
        const dollar = document.createElement('p')
        dollar.textContent = '$'
        productPriceDiv.appendChild(dollar)

        const productRatingDiv = document.createElement('div')
        productRatingDiv.classList.add('infor', 'product-rating')
        const productRatingInforEl = document.createElement('p')
        productRatingInforEl.classList.add('inforName')
        productRatingInforEl.textContent = 'Rating:'
        productRatingDiv.appendChild(productRatingInforEl)
        const productRatingValueEl = document.createElement('p')
        productRatingValueEl.classList.add('inforValue')
        productRatingValueEl.textContent = product.rating
        productRatingDiv.appendChild(productRatingValueEl)
        const starIconDiv = document.createElement('i')
        starIconDiv.classList.add('fa-solid', 'fa-star')
        productRatingDiv.appendChild(starIconDiv)

        const productStockDiv = document.createElement('div')
        productStockDiv.classList.add('infor', 'product-stock')
        const productStockInforEl = document.createElement('p')
        productStockInforEl.classList.add('inforName')
        productStockInforEl.textContent = 'Stock:'
        productStockDiv.appendChild(productStockInforEl)
        const productStockValueEl = document.createElement('p')
        productStockValueEl.classList.add('inforValue')
        productStockValueEl.textContent = product.stock
        productStockDiv.appendChild(productStockValueEl)

        const buyButtonDiv = document.createElement('div')
        buyButtonDiv.classList.add('buy-product')
        const buyButtonEl = document.createElement('button')
        buyButtonEl.textContent = 'Buy'
        buyButtonDiv.appendChild(buyButtonEl)

        productInforDiv.appendChild(productDescriptionDiv)
        productInforDiv.appendChild(productPriceDiv)
        productInforDiv.appendChild(productRatingDiv)
        productInforDiv.appendChild(productStockDiv)
        productInforDiv.appendChild(buyButtonDiv)

        productDiv.appendChild(productTitleDiv)
        productDiv.appendChild(productImageDiv)
        productDiv.appendChild(productInforDiv)
